...
<html >
  ...
  <body <?php if(isset($_GET[exception])) { ?> onLoad = "alert('<?php _returnError($_GET[exception]); ?>');" <?php } ?>>
    <div class="login">
		  <h1 style="padding-top: 10px;padding-bottom: 10px;">Cebu Provincial Hospital - Carcar City<br/><span style="font-size:10px">Barraca St., Pob. 2, Carcar City, Cebu</span></h1>
