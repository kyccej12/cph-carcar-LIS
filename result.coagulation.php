<?php 
    ...
    function checkTest($code,$serialno) {
     ...
     /* Previous Results */
     $c = $o->getArray("select *, concat('<br/>',date_format(result_date,'%m/%d/%Y')) as rdate from lab_coagulation where SUBSTR(enccode,16,15) = '$a[hpercode]' and result_date < '$a[xorderdate]' limit 1,1;");
     $d = $o->getArray("select *, concat('<br/>',date_format(result_date,'%m/%d/%Y')) as rdate from lab_coagulation where SUBSTR(enccode,16,15) = '$a[hpercode]' and result_date < '$a[xorderdate]' limit 2,1;");
     $e = $o->getArray("select *, concat('<br/>',date_format(result_date,'%m/%d/%Y')) as rdate from lab_coagulation where SUBSTR(enccode,16,15) = '$a[hpercode]' and result_date < '$a[xorderdate]' limit 3,1;");
            ...
            <td width=64% valign=top>
                <table width=100% id = "itemlist" class="cell-border" style="font-size:11px; font-weight: bold;">
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'PROTH_SEC',$b['proth_seconds']); ?></td>
                        <td><?php echo $c['proth_seconds']; ?></td>
                        <td><?php echo $d['proth_seconds']; ?></td>
                        <td><?php echo $e['proth_seconds']; ?></td>
                        <td><?php echo $o->getAttribute('PROTH_SEC',$a['age'],$a['xgender']); ?></td>	
                    </tr>
                    <input type="hidden" style="border: none; text-align: center; background-color: inherit !important;" name="proth_percent" id="proth_percent" value="<?php echo number_format($b['proth_percent'],2); ?>" >
                    ...
                    <!-- <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'PROTH_PERCENT',$b['proth_percent']); ?></td>
                        <td><?php echo $c['proth_percent']; ?></td>
                        <td><?php echo $d['proth_percent']; ?></td>
                        <td><?php echo $e['proth_percent']; ?></td>
                        <td><?php echo $o->getAttribute('PROTH_PERCENT',$a['age'],$a['xgender']); ?></td>	
                    </tr> -->
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'PROTH_INR',$b['proth_inr']); ?></td>
                        <td><?php echo $c['proth_inr']; ?></td>
                        <td><?php echo $d['proth_inr']; ?></td>
                        <td><?php echo $e['proth_inr']; ?></td>
                        <td><?php echo $o->getAttribute('PROTH_INR',$a['age'],$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'APTT_SEC',$b['aptt_seconds']); ?></td>
                        <td><?php echo $c['aptt_seconds']; ?></td>
                        <td><?php echo $d['aptt_seconds']; ?></td>
                        <td><?php echo $e['aptt_seconds']; ?></td>
                        <td><?php echo $o->getAttribute('APTT_SEC',$a['age'],$a['xgender']); ?></td>		
                    </tr>
                    <?php } ?>
