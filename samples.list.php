...
<script>
	...
	function writeResult() {
		...
		if(!lid) {
			...
			if(stat == '2') { msg = "It appears this sample has already been marked as \"Rejected\"! Please Restore Sample first..."; }
		...
		<tr>
			...
			<td align=right>
				...
				<select name="displayType" id="displayType" class="gridInput" style="width: 250px;" onchange="javascript: changeDiplay(this.value);">
					...
					<option value='2' <?php if($displayType == 2) { echo "selected"; } ?>>Sample Rejected</option>
