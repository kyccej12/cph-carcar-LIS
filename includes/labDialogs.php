...
<div id="ogtt" style="display: none;">
    ...
    <table width=100% cellpadding=0 cellspacing=0 valign=top>
            ...
            <td width=40% valign=top>  
                ...
                <table width=100% cellpadding=0 cellspacing=0 style="border: 1px solid #cdcdcd; padding: 10px; margin-bottom: 5px;">
                    ...
                    <tr>
                        <td align="left" width="35%"  class="bareBold" style="padding-right: 15px;">Order Reference No.&nbsp;:</td>
                        <td align=left>
                            <input class="gridInput" style="width:100%;" type=text name="ogtt_enccode" id="ogtt_enccode">
                        </td>				
                    </tr>
                    <tr><td height=3></td></tr>
                    <tr>
                ...
                <table width=100% cellpadding=0 cellspacing=0 style="border: 1px solid #cdcdcd; padding: 10px;">
                    ...
                    <tr>
                        <td align="left" width="35%" class="bareBold" style="padding-right: 15px;">Location&nbsp;:</td>
                        <td align=left>
                            <input type="text" class="gridInput" style="width:100%;" name="ogtt_location" id="ogtt_location" readonly>
                        </td>				
                    </tr>
            </table>
        </td> 
        ...
        <td width=74% valign=top >                
            ...
            <table width=100% cellpadding=0 cellspacing=3 class="td_content">
             <tr>
                <td align="left" width="20%"  class="bareBold" style="padding-right: 15px;">Result Date&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%;font-size:11px;" type=text name="dengue_date" id="dengue_date" value="<?php echo date('m/d/Y'); ?>">
                </td>								
                <td align="left" width="20%"  class="bareBold" style="padding-right: 15px;"></td>
                <td align=left>
                </td>								
            </tr>
            <tr><td height=2></td></tr>
            <tr>
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;">FBS&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%; font-size: 11px;" type=number name="ogtt_fbs" id="ogtt_fbs">
                </td>				
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;">FBS&nbsp; Urine&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%; font-size: 11px;" type=text name="ogtt_fbs_urine" id="ogtt_fbs_urine">
                </td>				
            </tr>
            <tr><td height=2></td></tr>
            <tr>
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;">After 1 Hour&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%; font-size: 11px;" type=number name="ogtt_fhours" id="ogtt_fhours">
                </td>				
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;">After 1 Hour&nbsp;Urine&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%; font-size: 11px;" type=text name="ogtt_fhours_urine" id="ogtt_fhours_urine">
                </td>				
            </tr>
            <tr><td height=2></td></tr>
            <tr>
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;">After 2 Hours&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%; font-size: 11px;" type=number name="ogtt_2hours" id="ogtt_2hours">
                </td>				
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;">After 2 Hours&nbsp;Urine&nbsp;:</td>
                <td align=left>
                    <input class="gridInput" style="width:100%; font-size: 11px;" type=text name="ogtt_2hours_urine" id="ogtt_2hours_urine">
                </td>				
            </tr>
            <tr><td height=2></td></tr>
            <tr>
                <td align="left" width="20%" class="bareBold" style="padding-right: 15px;" valign=top>Remarks&nbsp;:</td>
                <td align=left colspan=3>
                    <textarea name="ogtt_remarks" id="ogtt_remarks" style="width:100%;" rows=3></textarea>
                </td>				
            </tr>
            </table>
            </td>
...
<div id="ketoneResult" name="ketoneResult" style="display: none;"></div>
