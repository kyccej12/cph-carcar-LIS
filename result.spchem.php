                ...
                <table width=100% id = "itemlist" class="cell-border" style="font-size:11px;">
                    <thead>
                        <tr>
                            ...
                            <th width=12%>CURRENT RESULT</th>
                            <th width=10%>FLAG</th>
                            <th width=20%>PREVIOUS RESULT <?php echo $c['rdate']; ?></th>
                    ...
                    <?php } if(checkTest('L073',$order['serialno'])) { ?>
                    <tr>
                        <td>B-HCG</td>
                        <td>
                            <input type="text" class="noBorders" name="bhcg" id="bhcg" value="<?php echo number_format($b['bhcg'],2); ?>" pattern="^\d*(\.\d{0,2})?$">
                        </td>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L078',$b['crp']); ?></td>
                        <td><?php echo $c['crp']; ?></td>
                        <td><?php echo $o->getAttribute('L078',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <tr>
                        <td>HS-CRP</td>
                        <td>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'HSCRP',$b['hscrp']); ?></td>
                        <td><?php echo $c['hscrp']; ?></td>
                        <td><?php echo $o->getAttribute('HSCRP',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        <td>FT3</td>
                        <td>
                            <input type="text" class="noBorders"" name="ft3" id="ft3" value="<?php echo number_format($b['ft3'],2); ?>">
                        </td>
                    ...
                    <tr>
                        <td>TSH</td>
                        <td>
                            <input type="text" class="noBorders" name="tsh" id="tsh" value="<?php echo number_format($b['tsh'],2); ?>" onchange="javascript: computeBilirubin();">
                        </td>
