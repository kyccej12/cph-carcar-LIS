<?php 
    ...
    /* Previous Results */
    $c = $o->getArray("select *, concat('<br/>',date_format(result_date,'%m/%d/%Y')) as rdate from lab_bloodchem where SUBSTR(enccode,16,15) = '$a[hpercode]' and result_date < '$a[xorderdate]' limit 1,1;");
    $d = $o->getArray("select *, concat('<br/>',date_format(result_date,'%m/%d/%Y')) as rdate from lab_bloodchem where SUBSTR(enccode,16,15) = '$a[hpercode]' and result_date < '$a[xorderdate]' limit 2,1;");
    $e = $o->getArray("select *, concat('<br/>',date_format(result_date,'%m/%d/%Y')) as rdate from lab_bloodchem where SUBSTR(enccode,16,15) = '$a[hpercode]' and result_date < '$a[xorderdate]' limit 3,1;");
            ...
            <td width=64% valign=top>
                <table width=100% id = "itemlist" class="cell-border" style="font-size:11px;">
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L113',$b['glucose']); ?></td>
                        <td><?php echo $c['glucose']; ?></td>
                        <td><?php echo $d['glucose']; ?></td>
                        <td><?php echo $e['glucose']; ?></td>
                        <td><?php echo $o->getAttribute('L113',$a['age'],$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L132',$order['serialno'])) { ?>
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L132',$b['rbs']); ?></td>
                        <td><?php echo $c['rbs']; ?></td>
                        <td><?php echo $d['rbs']; ?></td>
                        <td><?php echo $e['rbs']; ?></td>
                        <td><?php echo $o->getAttribute('L132',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L004',$order['serialno'])) { ?>
                    <tr>
                        <td>Blood Uric Acid</td>
                        <td>
                            <input type="text" class="noBorders" name="uric" id="uric" value="<?php echo $b['uric']; ?>" pattern="^\d*(\.\d{0,2})?$">
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L004',$b['uric']); ?></td>
                        <td><?php echo $c['uric']; ?></td>
                        <td><?php echo $d['uric']; ?></td>
                        <td><?php echo $e['uric']; ?></td>
                        <td><?php echo $o->getAttribute('L004',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L005',$order['serialno'])) { ?>   
                    <tr>
                        <td>Blood Urea Nitrogen (BUN)</td>
                        <td>
                            <input type="text" class="noBorders" name="bun" id="bun" value="<?php echo number_format($b['bun'],2); ?>" pattern="^\d*(\.\d{0,2})?$">
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L005',$b['bun']); ?></td>
                        <td><?php echo $c['bun']; ?></td>
                        <td><?php echo $d['bun']; ?></td>
                        <td><?php echo $e['bun']; ?></td>
                        <td><?php echo $o->getAttribute('L005',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L155',$order['serialno'])) { ?>   
                    <tr>
                        <td>Magnesium</td>
                        <td>
                            <input type="text" class="noBorders" name="magnesium" id="magnesium" value="<?php echo number_format($b['magnesium'],2); ?>" pattern="^\d*(\.\d{0,2})?$">
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L155',$b['magnesium']); ?></td>
                        <td><?php echo $c['magnesium']; ?></td>
                        <td><?php echo $d['magnesium']; ?></td>
                        <td><?php echo $e['magnesium']; ?></td>
                        <td><?php echo $o->getAttribute('L155',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L020',$order['serialno'])) { ?>        
                    <tr>
                        <td>Creatinine</td>
                        <td>
                            <input type="text" class="noBorders" name="creatinine" id="creatinine" value="<?php echo $b['creatinine']; ?>">
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L020',$b['creatinine']); ?></td>
                        <td><?php echo $c['creatinine']; ?></td>
                        <td><?php echo $d['creatinine']; ?></td>
                        <td><?php echo $e['creatinine']; ?></td>
                        <td><?php echo $o->getAttribute('L020',$o->age,$a['gender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L023',$b['ldh']); ?></td>
                        <td><?php echo $c['ldh']; ?></td>
                        <td><?php echo $d['ldh']; ?></td>
                        <td><?php echo $e['ldh']; ?></td>
                        <td><?php echo $o->getAttribute('L023',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if (checkTest('L019',$order['serialno'])) { ?>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L019',$b['cholesterol']); ?></td>
                        <td><?php echo $c['cholesterol']; ?></td>
                        <td><?php echo $d['cholesterol']; ?></td>
                        <td><?php echo $e['cholesterol']; ?></td>
                        <td><?php echo $o->getAttribute('L019',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L134',$b['hdl']); ?></td>
                        <td><?php echo $c['hdl']; ?></td>
                        <td><?php echo $d['hdl']; ?></td>
                        <td><?php echo $e['hdl']; ?></td>
                        <td><?php echo $o->getAttribute('L134',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <tr>
                        <td>Triglycerides</td>
                        <td>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L032',$b['triglycerides']); ?></td>
                        <td><?php echo $c['triglycerides']; ?></td>
                        <td><?php echo $d['triglycerides']; ?></td>
                        <td><?php echo $e['triglycerides']; ?></td>
                        <td><?php echo $o->getAttribute('L032',$o->age,$a['xgender']); ?></td>	
                    </tr>                   
                    <tr>
                        <td>LDL - Chol</td>
                        <td >
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L018',$b['ldl']); ?></td>
                        <td><?php echo $c['ldl']; ?></td>
                        <td><?php echo $d['ldl']; ?></td>
                        <td><?php echo $e['ldl']; ?></td>
                        <td><?php echo $o->getAttribute('L018',$o->age,$a['xgender']); ?></td>	
                    </tr>   
                    <tr>
                        <td>VLDL</td>
                        <td>
                            <input type="text" class="noBorders" name="vldl" id="vldl" value="<?php echo $b['vldl']; ?>" pattern="^\d*(\.\d{0,2})?$"  />
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'VLDL',$b['vldl']); ?></td>
                        <td><?php echo $c['vldl']; ?></td>
                        <td><?php echo $d['vldl']; ?></td>
                        <td><?php echo $e['vldl']; ?></td>
                        <td><?php echo $o->getAttribute('VLDL',$o->age,$a['xgender']); ?></td>	
                    </tr>     
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L028',$b['sgot']); ?></td>
                        <td><?php echo $c['sgot']; ?></td>
                        <td><?php echo $d['sgot']; ?></td>
                        <td><?php echo $e['sgot']; ?></td>
                        <td><?php echo $o->getAttribute('L028',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L029',$b['sgpt']); ?></td>
                        <td><?php echo $c['sgpt']; ?></td>
                        <td><?php echo $d['sgpt']; ?></td>
                        <td><?php echo $e['sgpt']; ?></td>
                        <td><?php echo $o->getAttribute('L029',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L016',$b['sgpt']); ?></td>
                        <td><?php echo $c['alkaline']; ?></td>
                        <td><?php echo $d['alkaline']; ?></td>
                        <td><?php echo $e['alkaline']; ?></td>
                        <td><?php echo $o->getAttribute('L016',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L109',$b['bilirubin']); ?></td>
                        <td><?php echo $c['bilirubin']; ?></td>
                        <td><?php echo $d['bilirubin']; ?></td>
                        <td><?php echo $e['bilirubin']; ?></td>
                        <td><?php echo $o->getAttribute('L109',$o->age,$a['gender']); ?></td>	
                    </tr>           
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L003',$b['bilirubin_direct']); ?></td>
                        <td><?php echo $c['bilirubin_direct']; ?></td>
                        <td><?php echo $d['bilirubin_direct']; ?></td>
                        <td><?php echo $e['bilirubin_direct']; ?></td>
                        <td><?php echo $o->getAttribute('L003',$o->age,$a['gender']); ?></td>	
                    </tr>
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L149',$b['bilirubin_indirect']); ?></td>
                        <td><?php echo $c['bilirubin_indirect']; ?></td>
                        <td><?php echo $d['bilirubin_indirect']; ?></td>
                        <td><?php echo $e['bilirubin_indirect']; ?></td>
                        <td><?php echo $o->getAttribute('L149',$o->age,$a['gender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L027',$b['protein']); ?></td>
                        <td><?php echo $c['protein']; ?></td>
                        <td><?php echo $d['protein']; ?></td>
                        <td><?php echo $e['protein']; ?></td>
                        <td><?php echo $o->getAttribute('L027',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L001',$b['albumin']); ?></td>
                        <td><?php echo $c['albumin']; ?></td>
                        <td><?php echo $d['albumin']; ?></td>
                        <td><?php echo $e['albumin']; ?></td>
                        <td><?php echo $o->getAttribute('L001',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L110',$order['serialno'])) { ?>
                    <tr>
                        <td>Globulin</td>
                        <td>
                            <input type="text" class="noBorders" name="globulin" id="globulin" value="<?php echo number_format($b['globulin'],2); ?>" pattern="^\d*(\.\d{0,2})?$" >
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L110',$b['globulin']); ?></td>
                        <td><?php echo $c['globulin']; ?></td>
                        <td><?php echo $d['globulin']; ?></td>
                        <td><?php echo $e['globulin']; ?></td>
                        <td><?php echo $o->getAttribute('L110',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L001',$order['serialno']) && checkTest('L110',$order['serialno'])) { ?>
                    <tr>
                        <td>A/G Ratio</td>
                        <td>
                            <input type="text" class="noBorders" name="agratio" id="agratio" value="<?php echo number_format($b['agratio'],2); ?>" readonly>
                        </td>
                        <td></td>
                        <td></td>
                        <td>1.1 - 1.8</td>	
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L030',$b['electrolytes_na']); ?></td>
                        <td><?php echo $c['electrolytes_na']; ?></td>
                        <td><?php echo $d['electrolytes_na']; ?></td>
                        <td><?php echo $e['electrolytes_na']; ?></td>
                        <td><?php echo $o->getAttribute('L030',$o->age,$a['xgender']); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L026',$b['electrolytes_k']); ?></td>
                        <td><?php echo $c['electrolytes_k']; ?></td>
                        <td><?php echo $d['electrolytes_k']; ?></td>
                        <td><?php echo $e['electrolytes_k']; ?></td>
                        <td><?php echo $o->getAttribute('L026',$o->age,$a['xgender']); ?></td>
                    </tr>    
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L017',$b['electrolytes_ci']); ?></td>
                        <td><?php echo $c['electrolytes_ci']; ?></td>
                        <td><?php echo $d['electrolytes_ci']; ?></td>
                        <td><?php echo $e['electrolytes_ci']; ?></td>
                        <td><?php echo $o->getAttribute('L017',$o->age,$a['xgender']); ?></td>
                    </tr>
                    <tr>
                        <td style="padding-left: 35px;">Ionized Calcium</td>
                        <td>
                            <input type="text" class="noBorders" name="ion_calcium" id="ion_calcium" pattern="^\d*(\.\d{0,3})?$" value="<?php echo number_format($b['ion_calcium'],3); ?>">
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L130',$b['ion_calcium']); ?></td>
                        <td><?php echo $c['ion_calcium']; ?></td>
                        <td><?php echo $d['ion_calcium']; ?></td>
                        <td><?php echo $e['ion_calcium']; ?></td>
                        <td><?php echo $o->getAttribute('L130',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <!-- <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L006',$b['total_calcium']); ?></td>
                        <td><?php echo $c['total_calcium']; ?></td>
                        <td><?php echo $d['total_calcium']; ?></td>
                        <td><?php echo $e['total_calcium']; ?></td>
                        <td><?php echo $o->getAttribute('L006',$o->age,$a['xgender']); ?></td>	
                    </tr> -->
                    <?php } if(checkTest('L150',$order['serialno'])) {?>
                        <tr>
                        <td>Calcium</td>
                        <td>
                            <input type="text" class="noBorders" name="calcium" id="calcium" pattern="^\d*(\.\d{0,2})?$" value="<?php echo number_format($b['calcium'],2); ?>">
                        </td>
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L150',$b['calcium']); ?></td>
                        <td><?php echo $c['calcium']; ?></td>
                        <td><?php echo $d['calcium']; ?></td>
                        <td><?php echo $e['calcium']; ?></td>
                        <td><?php echo $o->getAttribute('L150',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } if(checkTest('L156',$order['serialno'])) {?>
                        <tr>
                            <td>Sodium (Na)</td>
                            <td>
                                <input type="text" class="noBorders" name="electrolytes_na" id="electrolytes_na" pattern="^\d*(\.\d{0,2})?$" value="<?php echo number_format($b['electrolytes_na'],2); ?>">
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['gender'],'L030',$b['electrolytes_na']); ?></td>
                        <td><?php echo $c['electrolytes_na']; ?></td>
                        <td><?php echo $d['electrolytes_na']; ?></td>
                        <td><?php echo $e['electrolytes_na']; ?></td>
                        <td><?php echo $o->getAttribute('L030',$o->age,$a['gender']); ?></td>
                    </tr>
                    ...
                    <?php } if(checkTest('L017',$order['serialno'])) { ?>    
                    <tr>
                        <td>Chloride (CI)</td>
                        <td >
                            <input type="text" class="noBorders" name="electrolytes_ci" id="electrolytes_ci" pattern="^\d*(\.\d{0,2})?$" value="<?php echo number_format($b['electrolytes_ci'],2); ?>">
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L025',$b['phosphorus']); ?></td>
                        <td><?php echo $c['phosphorus']; ?></td>
                        <td><?php echo $d['phosphorus']; ?></td>
                        <td><?php echo $e['phosphorus']; ?></td>
                        <td><?php echo $o->getAttribute('L025',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L021',$b['cbg']); ?></td>
                        <td><?php echo $c['cbg']; ?></td>
                        <td><?php echo $d['cbg']; ?></td>
                        <td><?php echo $e['cbg']; ?></td>
                        <td><?php echo $o->getAttribute('L021',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L133',$b['amylase']); ?></td>
                        <td><?php echo $c['amylase']; ?></td>
                        <td><?php echo $d['amylase']; ?></td>
                        <td><?php echo $e['amylase']; ?></td>
                        <td><?php echo $o->getAttribute('L133',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L135',$b['lipase']); ?></td>
                        <td><?php echo $c['lipase']; ?></td>
                        <td><?php echo $d['lipase']; ?></td>
                        <td><?php echo $e['lipase']; ?></td>
                        <td><?php echo $o->getAttribute('L135',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $o->checkChemValues($o->age,$a['xgender'],'L147',$b['procalcitonin']); ?></td>
                        <td><?php echo $c['procalcitonin']; ?></td>
                        <td><?php echo $d['procalcitonin']; ?></td>
                        <td><?php echo $e['procalcitonin']; ?></td>
                        <td><?php echo $o->getAttribute('L147',$o->age,$a['xgender']); ?></td>	
                    </tr>
                    <?php } ?>
