		...
		<tbody>
			<?php
				...
				while($row = $_i->fetch_array()) {
					...
					/* AUTOMATIC AS STAT FOR TROP I */
					if($row['proccode'] == 'LABOR00262') {
						$dopriority = "STAT";
					} else {
