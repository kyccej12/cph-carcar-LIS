                ...
                <td width=69% valign=top >
                    <table width=100% cellspacing=0 cellpadding=0><tr><td width=100% class=gridHead align=center>RESULT DETAILS</td></tr></table>
                        <table width=100% cellpadding=0 cellspacing=3 class="td_content">
                            ...
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="left" width="35%" class="bareBold" style="padding-right: 15px;">pH&nbsp;:</td>
                                <td align=left>
                            ...
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="left" width="35%" class="bareBold" style="padding-right: 15px;">PCO2&nbsp;:</td>
                                <td align=left>
                            ...
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="left" width="35%" class="bareBold" style="padding-right: 15px;">tHB&nbsp;:</td>
                                <td align=left>
                            ...
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="center" width="35%"  class="bareBold" style="padding-right: 15px; font-weight:bold;">CALCULATED&nbsp;</td>			
                            </tr>
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="left" width="35%" class="bareBold" style="padding-right: 15px;" valign=top>BE&nbsp;:</td>
                                <td align=left>
                                    <input class="gridInput" style="width:100%; font-size: 11px;" type=text name="abg_be" id="abg_be" value="<?php echo $b['be']; ?>">
                                </td>
                                <td></td>				
                            </tr>
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="left" width="35%" class="bareBold" style="padding-right: 15px;" valign=top>HCO3&nbsp;:</td>
                                <td align=left>
                            ...
                            <tr><td height=2></td></tr>
                            <tr>
                                <td align="left" width="35%" class="bareBold" style="padding-right: 15px;" valign=top>Hct(c)&nbsp;:</td>
                                <td align=left>
                                    <input class="gridInput" style="width:100%; font-size: 11px;" type=text name="abg_hctc" id="abg_hctc" value="<?php echo $b['hctc']; ?>">
                                </td>
                                <td></td>				
                            </tr>
                            <tr><td height=2></td></tr>
