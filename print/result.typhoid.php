...
/* MYSQL QUERIES SECTION */
    ...
    $b = $o->getArray("select * from lab_typhoid where enccode = '$order[enccode]' and serialno = '$order[serialno]' and `code` = '$order[code]';");
...
<table width=100% cellpadding=2 cellspacing=0 style="font-size: 8pt;margin-top:10px;">
	...
	<tr>
		<td width=100% colspan=4 style="background-color: #b1a0c7; border-top: 1px solid black; padding: 5px; font-size:11pt;" align=center><b>ANTI-SALMONELLA TYPHI/PARATYPHI IgG/IgM QUALITATIVE SCREENING TEST</b></td>
	</tr>    
</table>
...
<div id="main">
    ...
    <table width=90% cellpadding=0 cellspacing=0 align=center>
        ...
        <tr>
            <td width=20%></td>
            <td width=30%>IgM Anti-S. Typhi/ Paratyphi</td>
            <td width=30%><b>'.$b['typhoid_igm'].'</b></td>
            <td width=20%></td>
        </tr>
        <tr><td height=3>&nbsp;</td></tr>
        <tr>
            <td width=20%></td>
            <td width=30%>IgG Anti-S. Typhi/ Paratyphi</td>
            <td width=30%><b>'.$b['typhoid_igg'].'</b></td>
            <td width=20%></td>
        </tr>
    </table>
