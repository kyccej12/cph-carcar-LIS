...
/* MYSQL QUERIES SECTION */
    ...
    $b = $o->getArray("select *, TIME_FORMAT(time_collected,'%h:%i %p') as time_collected from lab_ketone where enccode = '$order[enccode]' and serialno = '$order[serialno]' and `code` = '$order[code]';");
...
mpdf-->
<div id="main">
    <table width=70% cellpadding=0 cellspacing=0 align=center style="margin: 5px;">
    ...
    <table align=center width=80% cellpadding=0 cellspacing=0 align=center>
        <tr>
            ...
            <td width=50%><b>MACROSCOPIC EXAMINATION</b></td>
            <td width=50%></td>
        </tr>
        <tr><td height=10></td></tr>
        <tr>
            <td width=20% style="padding-left:30px;"></td>
            <td width=30% style="padding-left:30px;">Color</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['color'].'</td>
        </tr>
        <tr><td height=5></td></tr>
        <tr>
            <td width=20% style="padding-left:30px;"></td>
            <td width=30% style="padding-left:30px;">Transparency</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['transparency'].'</td>
        </tr>
        <tr><td height=8></td></tr>
        <tr>
            <td width=20% style="padding-left:30px;"></td>
            <td width=50%><b>CHEMICAL EXAMINATION</b></td>
            <td width=50%></td>
        </tr>
        <tr><td height=10></td></tr>
        <tr>
            <td width=20% style="padding-left:30px;"></td>
            <td width=30% style="padding-left:30px;">Ketone</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['ketone'].'</td>
        </tr>
        <tr><td height=5></td></tr>
        <tr>
            <td width=20% style="padding-left:30px;"></td>
            <td width=30% style="padding-left:30px;">Time Collected</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['time_collected'].'</td>
        </tr>
    </table>
