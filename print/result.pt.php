...
/* MYSQL QUERIES SECTION */
    ...
    if($code == 'L039') {
        $title_header = "HEPATITIS B SURFACE ANTIGEN QUALITATIVE SCREENING TEST";
    }
    if($code == 'L140') {
        $title_header = "B-HCG PREGNANCY QUALITATIVE TEST";
    }
    if($code == 'L063') {
        $title_header = "PREGNANCY TEST";
    }
    if($code == 'L046') {
        $title_header = "ANTI-TP(TREPONEMA PALLIDUM/SYPHILIS) QUALITATIVE SCREENING TEST";
    }
    if($code == 'L043' || $code == 'L145') {
        $title_header = "ANTI-HEPATITIS C VIRUS ANTIBODY QUALITATIVE SCREENING TEST";
    }
    if($code == 'L062') {
        $title_header = "FECAL OCCULT BLOOD";
    }
    if($code == 'L159') {
        $title_header = "ANTI-STREPTOLYSIN QUALITATIVE TEST (ASO)";
    }
