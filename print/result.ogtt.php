...
<div id="main">
    <table width=100% cellpadding=0 cellspacing=0 align=center style="border-collapse: collapse; font-size: 9pt;">
		<tr>
			<td width=25% class="itemHeader" align=left>TEST</td>
			<td width=25% class="itemHeader">RESULT (BLOOD)</td>
			<td width=25% class="itemHeader">RESULT (URINE)</td>
			<td width=25% class="itemHeader">FLAG</td>
			<td width=25% class="itemHeader">NORMAL REFERENCE</td>
		</tr>
		<tr>
			<td class="itemResult" align=left><b>FASTING BLOOD SUGAR (BASELINE)</b></td>
			<td class="itemResult"><b>'.$b['result'].'</b></td>
			<td class="itemResult"><b>'.$b['result_urine'].'</b></td>
			<td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'OGTT_FBS',$b['result']).'</td>
			<td class="itemResult">60 - 100 mg/dL</td>
		</tr>
		<tr>
			<td class="itemResult" align=left><b>1 HOUR AFTER MEDIC ORANGE INTAKE</b></td>
			<td class="itemResult"><b>'.$b['result2'].'</b></td>
			<td class="itemResult"><b>'.$b['result2_urine'].'</b></td>
			<td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'OGTT_1HR',$b['result2']).'</td>
			<td class="itemResult">< 200 mg/dL</td>
		</tr>
		<tr>
			<td class="itemResult" align=left><b>2 HOURS AFTER MEDIC ORANGE INTAKE</b></td>
			<td class="itemResult"><b>'.$b['result3'].'</b></td>
			<td class="itemResult"><b>'.$b['result3_urine'].'</b></td>
			<td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'OGTT_2HR',$b['result3']).'</td>
			<td class="itemResult">< 140 mg/dL</td>
		</tr>
    </table>
