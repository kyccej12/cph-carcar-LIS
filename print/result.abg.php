...
<div id="main">
    ...
    <table align=center width=70% cellpadding=0 cellspacing=0 align=center>
        <tr>
            <td width=30%><b>MEASURED</b></td>
            <td width=30%><b>RESULT</b></td>
            <td><b>REFERENCE RANGES</b></td>
        </tr>
        <tr>
            <td width=30% style="padding-left:30px;">pH</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['ph'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('PH',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">PCO2</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['pco2'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('PCO2',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">PO2</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['po2'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('PO2',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">tHB</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['thb'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('THB',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">SO2</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['so2'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('SO2',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=5></td></tr>
        <tr>
            <td width=30%><b>CALCULATED</b></td>
            <td width=30%></td>
            <td width=30%></td>
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">BE</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['be'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('BE',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">HCO3</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['hco3'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('HCO3',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">Hct(c)</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['hctc'].'</td>
            <td width=30% valign=top>'.$o->getAttribute('HCTC',$o->age,$a['xgender']).'</td>	
        </tr>
        <tr><td height=5></td></tr>
        <tr>
            <td width=30%><b>ENTERED DATA</b></td>
            <td width=30%></td>
            <td width=30%></td>
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=30% style="padding-left:30px;">TEMP</td>
            <td width=30% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['temp'].'</td>
            <td width=30% valign=top><sup>o</sup>C</td>	
        </tr>
    </table>
