...
/* MYSQL QUERIES SECTION */
    ...
    $b = $con->getArray("select * from lab_cbs where enccode = '$order[enccode]' and `code` = '$order[code]' and serialno = '$order[serialno]';");
...
<table width=100% cellpadding=2 cellspacing=0 style="font-size: 10pt;margin-top:20px;">
	...
	<td colspan=4 width="100%" style="padding-top: 30px;" align=center>
		<span style="font-weight: bold; font-size: 12pt; color: #000000;">CLINICAL CHEMISTRY REPORT</span>
	</td>
	</tr>
	<tr>
	<td width=100% colspan=4 style="background-color: #8db4e2; border-top: 1px solid black; padding: 5px; font-weight: bold;" align=center>CLINICAL CHEMISTRY</td>
	</tr>  
</table>
...
<div id="main">
    <table width=95% cellpadding=0 cellspacing=0 align=center style="border-collapse: collapse; font-size: 9pt;">
		<tr>
			<td width=20% class="itemHeader" align=left>TIME</td>
			<td width=20% class="itemHeader">TEST</td>
			<td width=20% class="itemHeader">RESULT</td>
			<td width=20% class="itemHeader">REFERENCE RANGE</td>
			<td width=20% class="itemHeader">UNIT</td>
		</tr>
        <tr><td height=15></td></tr>
		<tr>
			<td class="itemResult" align=left>'.$b['time'].'</td>
			<td class="itemResult">CBS</td>
			<td class="itemResult">'.$b['result'].'</td>
			<td class="itemResult">70 - 100</td>
			<td class="itemResult">mg/dL</td>
		</tr>
    </table>
	<table width=95% align=center style="margin-top: 45px; font-size: 9pt; font-style: italic;">
        <tr>
