...
$mpdf=new mPDF('win-1252','letter','','',10,10,75,25,5,10);
...
<table width=80% cellpadding=0 cellspacing=5 align=center>
    ...
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"WBC").'</td>	
    </tr>
    ...
    <tr>
        ...
        <td align="left" style="padding-left: 15px;" valign=top>'.$con->getCBCAttribute($con->age,$a['gender'],"RBC").'</td>	
    </tr>
    ...
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'. $con->getCBCAttribute($con->age,$a['gender'],"HEMOGLOBIN") . '</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'. $con->getCBCAttribute($con->age,$a['gender'],"HEMATOCRIT").'</td>	
    </tr>
    ...
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"NEUTROPHILS").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"LYMPHOCYTES").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"MONOCYTES").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"EOSINOPHILS").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"BASOPHILS").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"MCV").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"MCH").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"MCHC").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"RDW-CV").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"RDW-SD").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"PLATELATE").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"MPV").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"PDW-CV").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"PDW-SD").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"PCT").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"P-LCC").'</td>	
    </tr>
    <tr>
        ...
        <td align="left" style="padding-left: 15px;">'.$con->getCBCAttribute($con->age,$a['gender'],"P-LCR").'</td>	
    </tr>
    <tr>
