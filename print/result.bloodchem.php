...
<htmlpagefooter name="myfooter">
    <table width=100% cellpadding=5 style="margin-bottom: 5px; font-size: 8pt;">
        <tr>
            <td width=80% colspan=4 style="border-bottom: 1px solid black; padding: 5px; font-size: 8pt;" align=center><b>***REPORTS ARE ELECTRONICALLY SIGNED OUT***</b>&nbsp; <br/> <u><i>For the interpretation of the results, kindly request your physician.</i></u></td>
        </tr>
        <tr>
...
if(checkTest('L113',$order['serialno']) && $b['glucose'] > 0) {
   ...
   /*  if($b['glucose'] <= 99) { $attr = "NORMAL"; }
    ...
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L113',$b['glucose']).'</td>
        <td align=center valign=top>'.$con->getAttribute('L113',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';

}

if(checkTest('L132',$order['serialno']) && $b['rbs'] > 0) {
    ...
    /*  if($b['glucose'] <= 99) { $attr = "NORMAL"; }
     ...
     $html .= '<tr>
         <td align="left">Random Blood Sugar</td>
         <td align=center style="border-bottom: 1px solid black;vertical-align: top;">'. $b['rbs'] . '</td>
         <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L132',$b['rbs']).'</td>
         <td align=center valign=top>'.$con->getAttribute('L132',$con->age,$a['xgender']).'</td>	
     </tr>
     <tr><td colspan=4 height=5>&nbsp;</td></tr>';
...
if(checkTest('L004',$order['serialno']) && $b['uric'] > 0) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L004',$b['uric']).'</td>
        <td align=center valign=top>'.$con->getAttribute('L004',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>
    ';
}
...
if(checkTest('L021',$order['serialno']) && $b['cbg'] > 0) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L021',$b['cbg']).'</td>
        <td align=center valign=top>'.$con->getAttribute('L021',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>
    ';
}
...
if(checkTest('L005',$order['serialno']) && $b['bun'] > 0) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L005',$b['bun']).'</td>
        <td align=center>'.$con->getAttribute('L005',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L020',$order['serialno']) && $b['creatinine'] > 0) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L020',$b['creatinine']).'</td>
        <td align=center>'.$con->getAttribute('L020',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L022',$order['serialno']) && $b['hba1c'] > 0) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L022',$b['hba1c']).'</td>
...
if($b['cholesterol'] > 0) {
    $html .= '<tr>
            ...
            <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L019',$b['cholesterol']).'</td>
            <td align=center>'.$con->getAttribute('L019',$con->age,$a['xgender']).'</td>	
        </tr>
        <tr><td colspan=4 height=5>&nbsp;</td></tr>';
...
if(checkTest('L071',$order['serialno']) && (($b['cholesterol'] + $b['tiglycerides'] + $b['hdl'] + $b['ldl'] + $b['vldl']) > 0) || checkTest('L139',$order['serialno'])) {
    ...
    if($b['triglycerides'] > 0) {
        ...
        <tr>
            ...
            <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L032',$b['triglycerides']).'</td>
            <td align=center>'.$con->getAttribute('L032',$con->age,$a['xgender']).'</td>	
        </tr>';
    }
    ...
    if($b['hdl'] > 0) {
        ...
        <tr>
            ...
            <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L134',$b['hdl']).'</td>
            <td align=center>'.$con->getAttribute('L134',$con->age,$a['xgender']).'</td>	
        </tr>';
    }
    ...
    if($b['ldl'] > 0) {
        ...
        <tr>
            ...
            <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L018',$b['ldl']).'</td>
            <td align=center>'.$con->getAttribute('L018',$con->age,$a['xgender']).'</td>	
        </tr>';
    }
    ...
    if($b['vldl'] > 0) {
        ...
        <tr>
            ...
            <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'VLDL',$b['vldl']).'</td>
            <td align=center>'.$con->getAttribute('VLDL',$con->age,$a['xgender']).'</td>	
        </tr>';
    }
}
...
if(checkTest('L028',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L028',$b['sgot']).'</td>
        <td align=center>'.$con->getAttribute('L028',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L023',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L023',$b['ldh']).'</td>
        <td align=center>'.$con->getAttribute('L023',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L029',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L029',$b['sgpt']).'</td>
        <td align=center>'.$con->getAttribute('L029',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L016',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L016',$b['alkaline']).'</td>
        <td align=center style="padding-left: 15px;">'.$con->getAttribute('L016',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}

if(checkTest('L003',$order['serialno'])) {
    $html .= '<tr>
        <td align="left">Total Bilirubin</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['bilirubin'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L003',$b['bilirubin']).'</td>
        <td align=center colspan=2>'.$con->getAttribute('L003',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
if(checkTest('L109',$order['serialno'])) {
    $html .= '<tr>
        <td align="left">Direct Bilirubin&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['bilirubin_direct'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L109',$b['bilirubin_direct']).'</td>
        <td align=center>'.$con->getAttribute('L109',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L003',$order['serialno']) && checkTest('L109',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. ($b['bilirubin']-$b['bilirubin_direct']) . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L149',$b['bilirubin_indirect']).'</td>
        <td align=center>'.$con->getAttribute('L149',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L027',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center></td>
        <td align=center>'.$con->getAttribute('L027',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L001',$order['serialno'])) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L001',$b['albumin']).'</td>
        <td align=center>'.$con->getAttribute('L001',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}

if(checkTest('L110',$order['serialno'])) {
    $html .= '<tr>
        <td align="left" style="padding-left: 35px;">Glubolin&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['globulin'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L110',$b['globulin']).'</td>
        <td align=center>'.$con->getAttribute('L110',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L156',$order['serialno'])) {
    $html .= '<tr>
        <td align="left">Sodium (Na)&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['electrolytes_na'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L030',$b['electrolytes_na']).'</td>
        <td align=center>'.$con->getAttribute('L030',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
    $html .= '<tr>
        <td align="left">Potassium (K)&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['electrolytes_k'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L026',$b['electrolytes_k']).'</td>
        <td align=center>'.$con->getAttribute('L026',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
...
if(checkTest('L080',$order['serialno'])) {
    ...
    if($b['electrolytes_ci'] > 0) {
        $html .= '
            <tr>
                ...
                <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L017',$b['electrolytes_ci']).'</td>
                <td align=center>'.$con->getAttribute('L017',$con->age,$a['xgender']).'</td>	
            </tr>
            <tr><td colspan=4 height=5>&nbsp;</td></tr>
    ...
    if($b['ion_calcium'] > 0) {   
        $html .= '
                <tr>
                    ...
                    <td align=center style="border-bottom: 1px solid black;">'. number_format($b['ion_calcium'],3) . '</td>
                    <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L130',$b['ion_calcium']).'</td>
                    <td align=center>'.$con->getAttribute('L130',$con->age,$a['xgender']).'</td>	
                </tr>
                <tr><td colspan=4 height=5>&nbsp;</td></tr>
        ';
    }
    ...
    //                 <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L006',$b['total_calcium']).'</td>
    //                 <td align=center>'.$con->getAttribute('L006',$con->age,$a['xgender']).'</td>	
    //             </tr>
    //             <tr><td colspan=4 height=5>&nbsp;</td></tr>
    //     ';
    // }
...
if(checkTest('L155',$order['serialno'])) {
    $html .= '<tr>
        <td align="left">Magnesium&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['magnesium'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L155',$b['magnesium']).'</td>
        <td align=center>'.$con->getAttribute('L155',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}

if(checkTest('L150',$order['serialno'])) {
    $html .= '<tr>
        <td align="left">Calcium&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['calcium'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L150',$b['calcium']).'</td>
        <td align=center>'.$con->getAttribute('L150',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L006',$order['serialno'])) {
    $html .= '<tr>
        <td align="left">Calcium&nbsp;:</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['calcium'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L006',$b['calcium']).'</td>
        <td align=center>'.$con->getAttribute('L006',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L133',$order['serialno'])) {
    ...
    $html .= '<tr>
        ...
        <td align=center>'.$flag.'</td>
        <td align=center>'.$con->getAttribute('L133',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if(checkTest('L135',$order['serialno'])) {
    ...
    $html .= '<tr>
        ...
        <td align=center>'.$flag.'</td>
        <td align=center>'.$con->getAttribute('L135',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
