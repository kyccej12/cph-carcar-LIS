<?php
    ...
    //list($room) = $con->getArray("SELECT concat(b.wardcode,'-',rmname,'-',bdname) FROM cph_carcar.lab_samples a LEFT JOIN hospital_dbo.hpatroom b ON a.enccode = b.enccode LEFT JOIN hospital_dbo.hroom c ON b.rmintkey = c.rmintkey LEFT JOIN hospital_dbo.hbed d ON b.bdintkey = d.bdintkey WHERE a.enccode = '$a[enccode]';");
    ...
    $mpdf=new mPDF('win-1252','BARCODE','','',0,0,0,1,0,0);
