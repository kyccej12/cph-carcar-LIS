...
if($b['crp'] != '') {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L078',$b['crp']).'</td>
        <td align="center">'.$con->getAttribute('L078',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>
    <tr>
        <td align="left">Hs-CRP</td>
        <td align=center style="border-bottom: 1px solid black;">'. $b['hscrp'] . '</td>
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'HSCRP',$b['hscrp']).'</td>
        <td align="center">'.$con->getAttribute('HSCRP',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>
    ';
}
...
if($b['ft4']) {
    $html .= '<tr>
        ...
        <td align="center">'.$con->getAttribute('L045',$con->age,$a['xgender']).'</td>	
    </tr>
    <tr><td colspan=4 height=5>&nbsp;</td></tr>';
}
...
if($b['tsh']) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L049',$b['tsh']).'</td>
...
if($b['t4']) {
    $html .= '<tr>
        ...
        <td align=center>'.$con->checkChemValues($con->age,$a['xgender'],'L048',$b['t4']).'</td>
