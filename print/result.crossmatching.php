...
/* MYSQL QUERIES SECTION */
    ...
    $b = $o->getArray("select *, date_format(cmr_expirydate1,'%m/%d/%Y') as cmr_expirydate1, date_format(cmr_expirydate2,'%m/%d/%Y') as cmr_expirydate2 from lab_crossmatching where enccode = '$order[enccode]' and serialno = '$order[serialno]' and `code` = '$order[code]';");
...
<head>
	<style>
        ...
        th { border: 1px solid black; padding: 7px; width:14%; }
...
<table width=100% cellpadding=2 cellspacing=0 style="font-size: 8pt;margin-top:10px;">
	...
	<tr>
		<td width=100% colspan=4 style="background-color: #f7d063; border-top: 1px solid black; padding: 5px; font-size:11pt;" align=center><b>CROSSMATCHING REPORT</b></td>
	</tr>    
</table>
...
<div id="main">
    ...
    <table width=90% cellpadding=0 cellspacing=0 align=center>
        <tr>
            <td width=15%>Patient Blood Type</td>
            <td>:</td>
            <td width=25% style="font-weight: bold; padding: 3px;">&nbsp;"'.$b['cmr_group'].'"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$b['cmr_group_pos'].'</td>
            <td>&nbsp;</td>
            <td width=10%>Examination</td>
            <td>&nbsp;:</td>
            <td width=35% style="font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_examination'].'</td>
        </tr>
    </table>
    <table><tr><td height=10></td></tr></table>
    <table width=90% cellpadding=0 cellspacing=0 align=center style="font-size: 10px;">
        <tr>
            <th>DONORS BLD TYPE</th>
            <th>RH Ag</th>
            <th>BLD COMP</th>
            <th>SERIAL NO.</th>
            <th>SEGMENT NO.</th>
        ...
        <tr>
            <td class="itemResult">'.$b['cmr_donor_btype1'].'</td>
            <td class="itemResult">'.$b['cmr_rh_ag1'].'</td>
            <td class="itemResult">'.$b['cmr_bld_comp1'].'</td>
            <td class="itemResult">'.$b['cmr_serialno1'].'</td>
            <td class="itemResult">'.$b['cmr_segment1'].'</td>
            <td class="itemResult">'.$b['cmr_expirydate1'].'</td>
            <td class="itemResult">'.$b['cmr_compatibility_res1'].'</td>
        </tr>';

    if($b['cmr_donor_btype2'] != '') {
     $html.=   '<tr>
            <td class="itemResult">'.$b['cmr_donor_btype2'].'</td>
            <td class="itemResult">'.$b['cmr_rh_ag2'].'</td>
            <td class="itemResult">'.$b['cmr_bld_comp2'].'</td>
            <td class="itemResult">'.$b['cmr_serialno2'].'</td>
            <td class="itemResult">'.$b['cmr_segment2'].'</td>
            <td class="itemResult">'.$b['cmr_expirydate2'].'</td>
            <td class="itemResult">'.$b['cmr_compatibility_res2'].'</td>
        </tr>';
    }
    ...
    <table width=90% align=center style="margin-top: 5px; font-size: 9pt; font-style: italic;">
            ...
            <tr>
                <td align="left" style="border-top: 1px solid black; margin-top: 20px;"><b>Remarks:</b> '.$b['cmr_remarks'].'</td>
            </tr>
    </table>
    <table width=96% align=center style="margin-top: 5px; font-size: 9pt; font-style: italic;">
    <tr><td height=15>&nbsp;</td></tr>
            <tr>
                <td align="center" style="margin-top: 20px;"><b>NOTE:</b> <b>BLOOD WILL AUTOMATICALLY BE PULLED OUT TO BLOOD POOL 3 DAYS AFTER CROSSMATCHED, IF NOT USED.</b></td>
            </tr>
    </table>
</div>
</body>
